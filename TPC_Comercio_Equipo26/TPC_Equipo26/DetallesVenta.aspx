...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-1">
                <asp:HyperLink ID="lnkVentaAnterior" runat="server" CssClass="grid-header" Style="color: lightgoldenrodyellow; font-weight: 300" title="Ver venta anterior"> << </asp:HyperLink>
            </div>
        ...
        <asp:GridView ID="gvDetalle" runat="server" CssClass="detalle" AutoGenerateColumns="false" Style="text-align: center; align-content: center; margin: 5px 20px 15px 30px;" Width="1200px"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Importe" DataField="" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="25%" />
            </Columns>
        </asp:GridView>
